...
var quads = [ //4 boyutlu face elementleri bulunuyor, 4genleri tanımlayan face elementleri (yani quadratic=4gensel)
...
window.onload = function init() {
    ...
    gl.clearColor( 1.0, 1.0, 1.0, 1.0 ); //ARKAPLAN RENGİ TANIMLANIYO
	...
	projectionMatrix = ortho(-20.0, 20.0, -20.0, 20.0, -20.0, 20.0); //vertices arrayimdeki değerlere bakarsan -20 20 arasında değerler vermişiz. 
																	//ortho yu silip mat4(); yazarsak def olarak -1 1 arasındaki verticeleri gösterecektir.
																	//ortho aslında projection view u verir bize görüntüleme kübünü veriyor.
...
function render() {
    ...
    for( var i=0; i<indices.length; i+=3)
       gl.drawElements( gl.LINE_LOOP, 3, gl.UNSIGNED_BYTE, i ); //wireframe yapısını görebilmek için line loop la çalıştırdık
}